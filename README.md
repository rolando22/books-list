...
El proyecto fue creado en el canal de YouTube de Goncy [Resolvemos la prueba técnica 1 de @midudev con Next.js, Tailwindcss y TypeScript](https://www.youtube.com/@goncypozzo).

Este repositorio contiene el código de una prueba técnica de una aplicación que lista libros, filtra por género y cantidad de páginas, se pueden añadir a una lista de lectura, eliminarlos de la lista de lectura y persistir la misma con Localstorage.
